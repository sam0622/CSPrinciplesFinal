...
class Player:
    ...
    def guess(self):
        ...
        while True:
            ...
            if guess.isalpha() and len(guess) == 5 and guess in game.words:  # Checks if the guess is comprised 100% of letters and is 5 letters long
