...
class Wordle:  # Class for the game mechanics
    ...
    def end_game(self, has_won):
        ...
        if input("Do you want to play again? (y/n) ").lower() == "y":  # Ask if the player wants to play again
            ...
            clear()
            import main  # I have to import it here or it dies
            main.menu.choose_game()
...
class Player:
    ...
    def guess(self):
        ...
        while True:
            ...
            if guess.isalpha() and len(guess) == 5 and guess in words:  # Checks if the guess is comprised 100% of letters and is 5 letters long
